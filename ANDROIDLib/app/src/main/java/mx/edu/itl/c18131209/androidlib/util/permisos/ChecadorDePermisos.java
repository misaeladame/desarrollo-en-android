...
package mx.edu.itl.c18131209.androidlib.util.permisos;
...
public class ChecadorDePermisos {
    ...
    public static void checarPermisos (Activity activity, PermisoApp [] permisosReq) {
        // Si el arreglo de permisos no trae nada
        ...
        if ( grantResults.length > 0 ) {
            ...
            for ( int i = 0; i < grantResults.length; i++ ) {
                ...
                if ( grantResults [ i ] == PackageManager.PERMISSION_GRANTED )
                    ...
                    // Sino se otorgo un permiso que es obligatorio anexar al string de no otorgados
    ...
    private static void alertarYSalir (final Activity activity, String noOtorgados ) {
        ...
        builder.setTitle ( "Permisos requeridos" )
                .setMessage ( "Los sigientes permisos son necesarios para " +
